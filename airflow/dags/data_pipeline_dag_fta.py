...
dag = DAG('Permitting_Pipeline_FTA', description='Data Pipeline to execute replication and ETL for FTA tables', schedule_interval='0 12 * * *', start_date=datetime(2017, 3, 20), catchup=False)
