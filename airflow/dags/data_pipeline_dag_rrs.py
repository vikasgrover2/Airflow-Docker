...
dag = DAG('Permitting_Pipeline_RRS', description='Data Pipeline to execute replication and ETL for RRS tables', schedule_interval='0 12 * * *', start_date=datetime(2017, 3, 20), catchup=False)
